...
def main():
    ...
    upcoming_earnings = get_upcoming_earnings(symbols, days_ahead=1, calendar=all_earnings)
    recent_earnings = get_recent_earnings(symbols, days_back=2, calendar=all_earnings)
