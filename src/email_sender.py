...
<tr style="background: #e2e8f0;">
    <td colspan="8" style="padding: 8px; font-weight: bold; color: #475569;">{category}</td>
</tr>""")
        ...
        for t in category_tickers:
            ...
            ps_str = f"{t.price_to_sales:.1f}" if t.price_to_sales else "-"
...
<tr style="border-bottom: 1px solid #eee;">
    ...
    <td style="padding: 6px 8px; text-align: right;">{ps_str}</td>
...
<tr style="background: #f5f5f5; text-align: left;">
    ...
    <th style="padding: 8px; border-bottom: 1px solid #ddd; text-align: right;">P/S</th>
